...
from cnw_ai.config import CHUNK_OVERLAP, CHUNK_SIZE, MIN_CHUNK_LENGTH
from cnw_ai.pipeline.models import ChunkDoc, ParsedDocument
...
def chunk_documents(
    ...
    *,
    ...
    for doc in documents:
        ...
        raw_chunks = _split_text(protected, chunk_size, chunk_overlap)
